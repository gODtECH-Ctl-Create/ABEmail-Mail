          ...
          <div className={styles.content}>
            ...
            <form className={styles.card} onSubmit={save}>
              ...
              <div className={styles.grid}>
                ...
                <label><span>Mailbox</span><select value={form.mailbox_address} onChange={(event) => setForm({ ...form, mailbox_address: event.target.value })}>{MAILBOXES.map((mailbox) => <option key={mailbox} value={mailbox}>{mailbox}</option>)}</select></label>
              </div>
